...
export const CX_ASSISTS: string[] = ["Assault", "Bumper", "Charge", "Dual", "Erase", "Free", "Heavy", "Jaggy", "Knuckle", "Massive", "Odd", "Round", "Slash", "Turn", "Vertical", "Wall", "Wheel", "Zillion"];
export const CX_ASSIST_TOP5: string[] = ["Wall", "Heavy", "Wheel", "Bumper", "Assault"];
