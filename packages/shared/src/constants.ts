...
export const STORAGE_KEYS = {
  ...
  matchStartIdx: "bx-match-start-idx-v1",
  ...
  overlayW: "ncblast-w",
  overlayH: "ncblast-h",
  // battle-phase per-group button-size multipliers (edit-mode feature)
  battleSizes: "bx-battle-sizes-v1",
  // Recently-succeeded idempotency keys (client-side dedup, 24h TTL, last 50)
  submitSucceeded: "bx-submit-succeeded-v1",
} as const;
